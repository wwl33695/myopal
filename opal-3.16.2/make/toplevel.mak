...
# $Revision: 33862 $
# $Author: rjongbloed $
# $Date: 2015-08-09 19:22:51 +0100 (Sun, 09 Aug 2015) $
#
...
install:
	...
	$(INSTALL) -m 644 $(OPAL_TOP_LEVEL_DIR)/make/*.mak $(DESTDIR)$(datarootdir)/opal/make
	$(INSTALL) -m 644 $(OPAL_TOP_LEVEL_DIR)/include/*.h $(DESTDIR)$(includedir)/opal
	for dir in $(INCSUBDIRS); \
	do \
	   $(MKDIR_P) $(DESTDIR)$(includedir)/opal/$$dir ; \
	   chmod 755 $(DESTDIR)$(includedir)/opal/$$dir ; \
	   $(INSTALL) -m 644 $(OPAL_TOP_LEVEL_DIR)/include/$$dir/*.h $(DESTDIR)$(includedir)/opal/$$dir ; \
	done
	$(INSTALL) -m 644 $(OPAL_TOP_LEVEL_DIR)/opal.pc $(DESTDIR)$(libdir)/pkgconfig
ifeq ($(OPAL_PLUGINS),yes)
