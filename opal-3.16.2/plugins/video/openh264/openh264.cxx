 ...
 * $Revision: 33754 $
 * $Author: rjongbloed $
 * $Date: 2015-07-26 15:01:41 +0100 (Sun, 26 Jul 2015) $
 */
...
static void CheckVersion(bool encoder)
{
  ...
  if (version.uMajor == OPENH264_MAJOR && version.uMinor == OPENH264_MINOR && version.uRevision == OPENH264_REVISION) {
    PTRACE(4, MY_CODEC_LOG, "Created " << (encoder ? "encoder" : "decoder")
           << ", plugin $Revision: 33754 $, DLL/API version " << version.uMajor << '.' << version.uMinor << '.' << version.uRevision);
  }
  else {
    PTRACE(1, MY_CODEC_LOG, "WARNING! Created " << (encoder ? "encoder" : "decoder")
           << ", plugin $Revision: 33754 $, with DLL version " << version.uMajor << '.' << version.uMinor << '.' << version.uRevision
