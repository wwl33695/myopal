 ...
 * $Revision: 32764 $
 * $Author: rjongbloed $
 * $Date: 2014-09-16 05:21:25 +0100 (Tue, 16 Sep 2014) $
 */
...
class MPEG4_Encoder : public PluginVideoEncoder<MY_CODEC>, public FFMPEGCodec
{
  ...
  public:
    ...
    { 
      PTRACE(4, m_prefix, "Created encoder $Revision: 32764 $");
    }
    ...
    virtual bool OnChangedOptions()
    {
      ...
      m_context->flags |= AV_CODEC_FLAG_AC_PRED
                    /* | AV_CODEC_FLAG_QPEL */ // don't enable this one: this forces profile_level to advanced simple profile
                       | AV_CODEC_FLAG_4MV
#if FF_API_GMC
                       | CODEC_FLAG_GMC
#endif
