...
/* #undef P_IOS */
/* #undef P_CYGWIN */
#define P_MINGW 2.11.2(0.329/5/3)
/* #undef P_GNU_HURD */
/* #undef P_ANDROID */
/* #undef P_UNKNOWN_OS */
...
/*   #undef P_NO_PTHREAD_KILL */
  #define P_HAS_SEMAPHORES 1
  #define P_STD_ATOMIC 1
/*   #undef P_ATOMICITY_BUILTIN */
...
/*   #undef P_HAS_BACKTRACE */
/*   #undef P_HAS_DEMANGLE */
/*   #undef P_PROFILING */
...
//#undef P_GUID
#define P_GUID 1
#define P_GETDATETAB_NOTGENERATED 0
