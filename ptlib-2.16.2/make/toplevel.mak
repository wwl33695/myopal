...
# $Revision: 33996 $
# $Author: rjongbloed $
# $Date: 2015-09-09 20:06:31 +0100 (Wed, 09 Sep 2015) $
#
...
install:
	...
	$(INSTALL) -m 444 $(PTLIB_TOP_LEVEL_DIR)/include/ptlib.h $(DESTDIR)$(includedir)
	$(INSTALL) -m 444 $(PTLIB_TOP_LEVEL_DIR)/include/ptlib_wx.h $(DESTDIR)$(includedir)
	$(INSTALL) -m 444 $(PTLIB_TOP_LEVEL_DIR)/include/ptlib_config.h $(DESTDIR)$(includedir)
	for fn in $(PTLIB_TOP_LEVEL_DIR)/include/ptlib/*.h $(PTLIB_TOP_LEVEL_DIR)/include/ptlib/*.inl; \
	   do $(INSTALL) -m 444 $$fn $(DESTDIR)$(includedir)/ptlib; \
	done
	for fn in $(PTLIB_TOP_LEVEL_DIR)/include/ptlib/$(OS_INCLUDE)/ptlib/*.h $(PTLIB_TOP_LEVEL_DIR)/include/ptlib/$(OS_INCLUDE)/ptlib/*.inl ; \
	   do $(INSTALL) -m 444 $$fn $(DESTDIR)$(includedir)/ptlib/$(OS_INCLUDE)/ptlib ; \
	done
	for fn in $(PTLIB_TOP_LEVEL_DIR)/include/ptclib/*.h ; \
	   do $(INSTALL) -m 444 $$fn $(DESTDIR)$(includedir)/ptclib; \
	done
	for fn in $(PTLIB_TOP_LEVEL_DIR)/make/*.mak ; \
	   do $(INSTALL) -m 444 $$fn $(DESTDIR)$(datarootdir)/ptlib/make; \
	done
	$(INSTALL) -m 644 $(PTLIB_TOP_LEVEL_DIR)/ptlib.pc $(DESTDIR)$(libdir)/pkgconfig
